<script>
  ...
  ga('create', 'UA-5683162-4', 'wikipaltz.org');
  ga('send', 'pageview');
...
# include_once("$IP/ProfilerSettings.php");

include_once("$IP/DatabaseSecrets.php"); # We don't want the database creds and secret key in the repo.
